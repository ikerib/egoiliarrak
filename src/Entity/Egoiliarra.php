...
class Egoiliarra
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Barrutia", inversedBy="egoiliarras")
     */
    private $barrutia;
    ...
    public function getBarrutia(): ?Barrutia
    {
        return $this->barrutia;
    }

    public function setBarrutia(?Barrutia $barrutia): self
    {
